...
public:
   ...
   */
  static IRGBController* createRGBController(const IRGBController::PinDescriptor& pinDescriptor, const Resolution& resolution = Medium);
   ...
   * \return An IRGBController instance
   */
  static ILEDController* createLEDController(const pin_t& pin, const Resolution& resolution = Medium);
};